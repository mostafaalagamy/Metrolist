package com.zionhuang.lrclib

import com.zionhuang.lrclib.models.Track
import com.zionhuang.lrclib.models.bestMatchingFor
...
//}.body<List<Track>>().filter { it.syncedLyrics != null }
    ...
    suspend fun getAllLyrics(title: String, artist: String, duration: Int, album: String? = null, callback: (String) -> Unit) {
        val tracks = queryLyrics(artist, title, album)
        var count = 0
        var plain = 0
        tracks.forEach {
