...
class HomeViewModel @Inject constructor(
            ...
            when (quickPicksEnum.first()) {
                ...
                QuickPicks.LAST_LISTEN -> {
                    ...
                    if (song != null && database.hasRelatedSongs(song.id)) {
                        quickPicks.value = database.getRelatedSongs(song.id)
                            .first()
                            .shuffled()
                            .take(20)
                    }
    ...
    private suspend fun load() {
        ...
        try {
            ...
            val artistRecommendations = database.mostPlayedArtists(fromTimeStamp, limit = 10)
                .first()
            ...
            val songRecommendations = database.mostPlayedSongs(fromTimeStamp, limit = 10)
                .first()
                ...
                .mapNotNull { song ->
                    val endpoint = YouTube.next(WatchEndpoint(videoId = song.id))
                        .getOrNull()?.relatedEndpoint ?: return@mapNotNull null
            ...
            allLocalItems.value = (quickPicks.value.orEmpty() +
    ...
    init {
        viewModelScope.launch(syncCoroutine) {
            ...
            try {
                ...
                if (isSyncEnabled && YouTube.cookie != null) {
