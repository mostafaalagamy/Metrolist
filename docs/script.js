...
const translations = {
    ...
    pt: {
        ...
        gallery_title: "Galeria", faq_title: "Perguntas Frequentes",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const userLang = navigator.language.slice(0, 2); // gets 'en', 'fr', 'es', etc.
    const validLangs = ['en', 'fr', 'es', 'it', 'pt'];
    const currentLang = validLangs.includes(userLang) ? userLang : 'en';
